...
midpath = 'nh/CNNd/valid/'

f = 0#int(os.environ["F"])
c = 1#int(os.environ["C"])
...
# Gridded cnn data
file_list = sorted(glob.glob(f"/scratch3/dpappert/CESM2/ML/CNN/input_per_member/3x3/nh/cl{c}/r*.nc"))
...
for params in itertools.product(*param_grid.values()):
    ...
    for k in range(7):
        ...
        model = CNNd(in_channels=X.shape[1])
